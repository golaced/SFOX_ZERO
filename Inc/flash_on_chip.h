#ifndef _FLASH_ON_CHIP_H_
#define _FLASH_ON_CHIP_H_
...
extern uint8_t save_arry[max_flash_save_len];
extern short save_time;
...
extern uint8_t flash_read_parameters(void);
