...
//float vel_north,pos_east,vel_down;
...
MatDataType ekf_sigmas_quad_process_noise = 0.00001;
MatDataType ekf_sigmas_pos_process_noise_m = 0.00001;
MatDataType ekf_sigmas_vel_process_noise_mps = 0.00001;
MatDataType ekf_sigmas_gyroBias_process_noise_rps = 1e-7;
MatDataType ekf_sigmas_accelBias_process_noise_mps2 = 1e-7;

MatDataType ekf_sigmas_mag3D_unitVector_meas = 2.0f;
